            ...
            <div className={styles.contact__container}>
                <div className={styles.contact__info}>
                    <div className={styles.contact__card}>
                        ...
                        <span className={styles.contact__card_data}>sulaimabaliqis@gmail.com</span>
                        <a href="mailto:sulaimabaliqis@gmail.com" className={styles.contact__button}>
                            Write me
                    ...
                    <div className={styles.contact__card}>
                        ...
                        <span className={styles.contact__card_data}>+2348105795528</span>
                        <a href="https://wa.me/2348105795528" className={styles.contact__button} target="_blank" rel="noopener noreferrer">
                            Message me
                            <i className={`bx bx-right-arrow-alt ${styles.contact__button_icon}`}></i>
                        </a>
                    </div>
