...
import CV from "../../assets/BimsCv.pdf"
            ...
            <div className={styles.about__container}>
                <div className={styles.about__data}>
                    ...
                    <p className={styles.about__description}>
                        My journey into coding began in 2023, driven by a deep curiosity
                        about how software powers our digital world. In this short time,
                        I’ve developed a strong passion for solving problems and building efficient,
                        user-friendly applications.

                        I thrive in collaborative environments,
                        valuing teamwork and knowledge-sharing to deliver impactful solutions.
                        I follow best practices like test-driven development, ensuring clean and maintainable code.
                        Eager to embrace new challenges and continuously learn,
                        I’m committed to contributing to innovative and impactful projects.
